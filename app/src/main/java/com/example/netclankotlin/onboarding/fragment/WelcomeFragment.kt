package com.example.netclankotlin.onboarding.fragment
...
class WelcomeFragment : Fragment() {
    ...
    private fun networkCalls() {
        RequestFormatter.jsonObjectGetOtp("7005667113","91",0)?.let { getOtpViewModel.getOtpViewModel(it) }
        getOtpViewModel.getOtpLiveData.observe(viewLifecycleOwner, Observer {
            ...
            RequestFormatter.jsonObjectVerifyOtp("7005667113","91", PrefManager.getInstance(this.requireActivity()).sessionId)
